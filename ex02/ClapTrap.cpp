...
ClapTrap::ClapTrap(): _name("default"), _hitpoints(CT_DEFAULT_HP), _energyPoints(CT_DEFAULT_EP), _attackDamage(CT_DEFAULT_AD), _hitpointsMax(CT_DEFAULT_HP)
{
	// Default constructor
	std::cout << "ClapTrap default constructor called" << std::endl;
}

ClapTrap::ClapTrap(std::string name): _name(name), _hitpoints(CT_DEFAULT_HP), _energyPoints(CT_DEFAULT_EP), _attackDamage(CT_DEFAULT_AD), _hitpointsMax(CT_DEFAULT_HP)
{
	// Constructor
